...
class PIDController():
    def __init__(self,node :Node):
        ...
        self.pwm_pub = node.create_publisher(Twist, "/pwm_output",1)
    ...
    def joystick_control(self):
        if(self.axes!=[]):
            if(self.axes[4]>0 and self.axes[0]==0):
                self.joystick_out.linear.x=100.0
                self.joystick_out.linear.y=100.0
                self.joystick_out.linear.z=100.0
                self.joystick_out.angular.x=100.0
                self.joystick_out.angular.y=100.0
                self.joystick_out.angular.z=100.0
                ...
                self.joystick_out.linear.y=100.0
                self.joystick_out.linear.z=100.0
                self.joystick_out.angular.x=50.0
                self.joystick_out.angular.y=50.0
                self.joystick_out.angular.z=50.0
            elif(self.axes[0]<0 and self.axes[4]>0):
                self.joystick_out.linear.x=50.0
                self.joystick_out.linear.y=50.0
                self.joystick_out.linear.z=50.0
                self.joystick_out.angular.x=100.0
                self.joystick_out.angular.y=100.0
                self.joystick_out.angular.z=100.0
            elif(self.axes[0]>0 and self.axes[4]<0):
                ...
                self.joystick_out.linear.y=0.0
                self.joystick_out.linear.x=0.0 
                self.joystick_out.linear.z=0.0
                self.joystick_out.angular.y=0.0
                self.joystick_out.angular.x=0.0
                self.joystick_out.angular.z=0.0       
        self.pwm_pub.publish(self.joystick_out)
