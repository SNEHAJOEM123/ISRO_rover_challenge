...
class PIDController():
    def __init__(self,node :Node):
        self.node= node
        self.set_point = 3000        # Setpoints for x, y, z respectively      
    ...
    def pid(self):          # PID algorithm
        ...
        self.pid_pub.publish(self.encoder_out)
    #------------------------------------------------------------------------------------------------------------------------

    def joystick_control(self):
        if(self.axes!=[]):
            if(self.axes[4]>0 and self.axes[0]==0):
                self.encoder_out.x=100.0
                self.encoder_out.y=100.0
            elif(self.axes[4]<0 and self.axes[0]==0):
                self.encoder_out.x=-100.0
                self.encoder_out.y=-100.0
            elif(self.axes[0]>0 and self.axes[4]>0):
                self.encoder_out.x=50.0
                self.encoder_out.y=100.0
            elif(self.axes[0]<0 and self.axes[4]>0):
                self.encoder_out.y=50.0
                self.encoder_out.x=100.0
            elif(self.axes[0]>0 and self.axes[4]<0):
                self.encoder_out.y=-100.0
                self.encoder_out.x=-50.0
                ...
                self.encoder_out.y=0.0
                self.encoder_out.x=0.0        
