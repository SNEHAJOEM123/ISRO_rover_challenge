...
static const _PidTune_type_support_symbol_names_t _PidTune_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pid_msg, msg, PidTune)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pid_msg, msg, PidTune)),
  }
};
...
{
  return &::pid_msg::msg::rosidl_typesupport_cpp::PidTune_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pid_msg, msg, PidTune)() {
  return get_message_type_support_handle<pid_msg::msg::PidTune>();
}
